                        ...
                        <div class="card-body">
                            <div class="container-fluid d-flex justify-content-between">
                                <div class="col-lg-3 ps-0">
                                    <a href="#"
                                        class="noble-ui-logo logo-light d-block mt-3">Real<span>Estate</span></a>
                                    <p class="mt-1 mb-1"><b>Real Estate</b></p>
                                ...
                                <div class="col-lg-3 pe-0">
                                    ...
                                    <h6 class="mb-0 mt-3 text-end fw-normal mb-2"><span class="text-muted"></span>
                                    </h6>
                                </div>
                            </div>
                            ...
                            <div class="container-fluid w-100">
                                ...
                                <button type="submit" class="btn btn-primary float-end mt-3 mb-2"><i data-feather="send"
