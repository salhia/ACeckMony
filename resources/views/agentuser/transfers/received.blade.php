...
<div class="page-content">
    ...
    <div class="mb-3">
        <a href="{{ route('agent.received.transfers', ['status' => 'pending']) }}" class="btn btn-warning btn-sm">
            <i data-feather="clock"></i> Pending
        </a>
        <a href="{{ route('agent.received.transfers', ['status' => 'completed']) }}" class="btn btn-success btn-sm">
            <i data-feather="check-circle"></i> Completed
        </a>
        <a href="{{ route('agent.received.transfers', ['status' => 'rejected']) }}" class="btn btn-danger btn-sm">
            <i data-feather="x-circle"></i> Rejected
        </a>
        <a href="{{ route('agent.received.transfers', ['status' => 'delivered']) }}" class="btn btn-primary btn-sm">
    ...
    <button class="btn btn-success btn-xs status-btn" data-id="{{ $transaction->id }}" data-status="delivered" title="Deliver">
        <i data-feather="truck"></i>
    </button>

    <button class="btn btn-danger btn-xs status-btn" data-id="{{ $transaction->id }}" data-status="rejected" title="Reject">
        <i data-feather="x-circle"></i>
    </button>

    <button class="btn btn-warning btn-xs status-btn" data-id="{{ $transaction->id }}" data-status="pending" title="Pending">
